...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start bg-linear-to-b from-cyan-100/70 justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        {/* left column */}
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by <span className="text-blue-600 underline">Isaac .O.</span>
          </p>
